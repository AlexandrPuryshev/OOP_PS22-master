...
//////////////////////////////////////////////////////////////////////////
BOOST_AUTO_TEST_CASE(TestBinaryMultiplyOperator)
{
	{
		CRational const rational1(1, 2), rational2(2, 3);
		CRational r = rational1 * rational2;
		BOOST_CHECK_EQUAL(r.GetNumerator(), 1);
		BOOST_CHECK_EQUAL(r.GetDenominator(), 3);
	}
	...
	{
		CRational const rational1(3), rational2(1, 2);
		CRational r = rational1 * rational2;
		BOOST_CHECK_EQUAL(r.GetNumerator(), 3);
		BOOST_CHECK_EQUAL(r.GetDenominator(), 2);
	}
...
BOOST_AUTO_TEST_CASE(TestCompare)
{
	...
	{
		CRational const rational2(1, 2), rational1(1, 3);
		BOOST_CHECK(!(rational1 > rational2));
		BOOST_CHECK(rational1 < rational2);
		BOOST_CHECK(!(rational1 >= rational2));
		BOOST_CHECK(rational1 <= rational2);
